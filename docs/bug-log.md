...
## 2026-03-06 - DTO annotation import mismatch
...
## 2026-03-06 - Mockito inline agent and final-record mocking issues
...
## 2026-03-06 - Spotify pager null handling
...
## 2026-03-06 - callback album aggregation null-safety
...
## 2026-03-06 - frontend state module fast-refresh lint issue
...
## 2026-03-06 - range hydration fallback behavior
...
## 2026-03-06 - protected-route fallback hardening
...
- Symptom: album/artist/playlist page transitions did not match expected interaction patterns after incremental refactors.
...
- Fix: restored expected interaction classes and paging semantics:
...
## 2026-03-07 - currently-playing refresh fallback hardening
...
## 2026-03-07 - polling/state hydration continuity
...
## 2026-03-07 - vinyl layout hardcoded sizing risk
- Area: Frontend player page and vinyl deck composition
- Risk: previous player implementation used hardcoded dimensions and full-viewport assumptions that degrade on different monitor sizes.
...
## 2026-03-07 - currently-playing 404 resilience and api-base normalization
...
## 2026-03-07 - protected shell extraction and navbar session menu hardening
...
## 2026-03-07 - frontend test harness + player/route/poller coverage
...
## 2026-03-07 - local-files placeholder + snapshot URI safety
